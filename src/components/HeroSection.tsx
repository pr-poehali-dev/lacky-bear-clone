...
const HeroSection = () => {
  return (
    <section className="bg-gradient-to-b from-black via-gray-900 to-black py-16 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-yellow-500/5 to-transparent opacity-30 bg-[radial-gradient(circle_at_25%_25%,_#ffd700_1px,_transparent_1px)] bg-[length:30px_30px]"></div>
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center items-center mb-12">
          ...
          <Button
            variant="outline"
            className="border-2 border-yellow-500 text-yellow-400 px-8 py-3 text-lg hover:bg-yellow-500 hover:text-black"
          >
            💰 Бонус +100%
          </Button>
        </div>
